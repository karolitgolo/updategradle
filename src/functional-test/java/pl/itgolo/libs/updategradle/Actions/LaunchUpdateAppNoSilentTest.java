 ...
 */
public class LaunchUpdateAppNoSilentTest extends PluginFunctionalTest {
    ...
    public void setup() throws IOException, URISyntaxException {
        ...
        appDir = testProjectDir.newFolder("appNoSilent");
    ...
    @Test
    public void updateByExternalApplicationNoSilent() throws IOException, InterruptedException {
        File appExternal = testProjectDir.newFolder("appExternalNoSilent");
        ...
        FileUtils.copyDirectoryStructure(srcDir, new File(appExternal, "test"));
        ...
        FileUtils.deleteDirectory(new File(appExternal, "test"));
        ...
        argsLaunchAppJarAfterUpdate.put("--appTitle", "TitleApp");
        ...
        argsLaunchAppJar.put("--appTitle", "AppTile");
